    ...
    <section className="fullHeight" id="fullHeight">
      ...
      <section className="flex flex-row justify-around items-center">
        <article className="bg-lightRed p-4 w-[75vw] flex flex-col gap-[4vh]">
          <h2 className="verylargeHeader text-black">Work.</h2>
          <h2 className="verylargeHeader text-black">Build & Design.</h2>
          <h2 className="verylargeHeader text-black">TypeScript & React.</h2>
